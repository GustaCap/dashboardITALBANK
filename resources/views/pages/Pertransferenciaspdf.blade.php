...
<html lang="es">
    ...
    <body>
        <div class="container-fluid">
            <h3>Reporte de Transferencias Cargadas</h3>
        ...
        <hr>
            <table class="table table-striped table-sm table-bordered">
                ...
                <tbody class="text-center">
                    ...
                    <td valign="middle">{{ $item->n_cuenta }}</td>
                    <td valign="middle">{{ $item->n_transfer }}</td>
                    <td valign="middle">{{ $item->via_payment }}</td>
                    <td valign="middle">{{ $item->channel }}</td>
                    <td valign="middle">{{ $item->nombre_bene }}</td>
                    <td valign="middle">{{ $item->cuenta_bene }}</td>
                    <td valign="middle">{{ $item->banco_bene }}</td>
